...
ActiveRecord::Schema.define(version: 20170615130411) do
  ...
  create_table "beach_api_core_actions", force: :cascade do |t|
    t.string "name"
    t.integer "controller_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["controller_id"], name: "index_beach_api_core_actions_on_controller_id"
  end
  ...
  create_table "beach_api_core_controllers", force: :cascade do |t|
    t.string "name"
    t.integer "service_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["service_id"], name: "index_beach_api_core_controllers_on_service_id"
  end
  ...
  add_foreign_key "beach_api_core_actions", "beach_api_core_controllers", column: "controller_id"
  ...
  add_foreign_key "beach_api_core_controllers", "beach_api_core_services", column: "service_id"
