app.directive('actionSelector', ['$compile', 'ngDialog', function($compile, ngDialog){
  ...
  return {
    ...
    controller: ['$scope', function($scope) {
      $scope.availableActions = ['GO_TO_SCREEN_BY_ID', 'OPEN_FLOW', 'NEXT_SCREEN', 'PREV_SCREEN', 'SUBMIT_ON_SERVER', 'SOCIAL_NETWORKS_ACTION', 'OPEN_MENU', 'OPEN_MODAL', 'OPEN_IFRAME', 'OPEN_CAMERA', 'OPEN_GALLERY', 'OPEN_APP']
